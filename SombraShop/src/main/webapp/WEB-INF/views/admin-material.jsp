		...
		<div class="row">
			<div class="col-md-12 col-xs-12">
				...
				<div class="form-group">
						<label for="material" style="color:red;text-align:left;" class="col-sm-10 col-sm-offset-2 control-label"><form:errors path="name"/></label>
					</div>
					<div class="form-group">
    					<label for="material" class="col-sm-2 control-label">Material</label>
    					<div class="col-sm-10">
      						<form:input class="form-control" path="name" id="material"/>
    					</div>
  					</div>
